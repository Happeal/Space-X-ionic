...
var DetailsLaunchPage = /** @class */ (function () {
    function DetailsLaunchPage(navCtrl, navParams, spacexApi) {
        ...
        this.spacexApi.getLaunchpadsByName(this.launch.launch_site.site_name).subscribe(function (data) {
...
var SpacexApiProvider = /** @class */ (function () {
    ...
    SpacexApiProvider.prototype.getLaunchpadsByName = function (name) {
